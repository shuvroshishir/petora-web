    ...
    return (
        <section className="bg-background py-6">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8max-w-5xl">
                <div className="overflow-hidden rounded-[32px] border border-primary/10 bg-background shadow-xl shadow-primary/20 lg:grid lg:min-h-[92vh] lg:grid-cols-2">

                    {/* Left Side */}
                    <div className="relative hidden lg:block">
                        <Image
                            src="https://images.unsplash.com/photo-1519052537078-e6302a4968d4?q=80&w=1400&auto=format&fit=crop"
                            alt="Pet"
                            fill
                            priority
