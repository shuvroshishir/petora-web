    ...
    return (
        <section className="flex min-h-screen items-center justify-center bg-background py-10">
            <div className="container">
                <div className="mx-auto max-w-5xl overflow-hidden rounded-[32px] border border-primary/10 bg-background shadow-2xl lg:grid lg:grid-cols-2">
                    ...
                    <div className="flex items-center justify-center p-8 sm:p-12 lg:p-16">
                        <div className="text-center">
                            ...
                            <p className="mt-5 max-w-md text-lg leading-relaxed text-muted-foreground">
                                ...
                                Let’s get you back to exploring adorable pets.
                            </p>

                            <Link href="/" className="mt-10 inline-block">
                                <Button
                                    size="lg"
                                    className="bg-gradient px-8 font-semibold text-white transition-all duration-300 hover:scale-105"
                                >
                                    <FaArrowLeft />
